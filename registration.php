...
if(isset($_POST['submit'])){ 
	...
	$s = "select * from register where emailUsers = '$username'";
	
	$result = mysqli_query($conn,$s);
	
	$num = mysqli_num_rows($result);
	if($num == 1){ 
		echo"<h3> Email already exsit </h3>";
	}else{ 
	
	$query = "insert into register (emailUsers,pwdUser) values ('$username','$hashed_password')";
...
<title>Student Matching Registration</title>
</head>
<body>
...
<h1><center>Please register with your USF email and create a password</center></h1>
...
<form action = "registration.php" method="post">
  Create your username using your USF email and a password. When done press "Submit" and then click "Return to Log in" <br>Remember your log in because you will need this information to view your Student Matching results! <br>
	<label for="username">Username: </label>
	<input type="text" name="username" pattern=".+@usf.edu" title="Include @usf.edu" required>
	<br>
	...
	<button type = "submit">Return to Log in</button>  
