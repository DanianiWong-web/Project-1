...
<title>Home - Student Matching</title>
</head>
<body>
...
<br>
<h3><center>Please take the student matching questionnaire. Our algortihm will match you with other students in your class who have similarities as you, making the group choosing process simpler.</center></h3 >
<body>
<form action= "homepage.php" id="form1" name="Welcome" method="post">
</form>
<form action = "question.php">
	<button type="submit">Take The Questionnaire</button> 
	</form>
<h3><center>Already took the Questionnaire? View the results here!</center></h3>
